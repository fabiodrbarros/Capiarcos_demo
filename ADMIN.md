...
5. «Eliminar item» apaga o registo diretamente do catálogo, após confirmação, sem passar por «Itens retirados». Não há recuperação no painel. Os ficheiros privados e backups técnicos continuam guardados; a imagem eliminada deixa de ser servida pela API. A secção «Itens retirados» foi removida. Registos antigos retirados permanecem ocultos nos dados históricos.

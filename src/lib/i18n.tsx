...
export const dict = {
  pt: {
    ...
    empresa: {
      ...
      about_p1: 'Capiarcos – Sociedade Unipessoal de Carpintaria, Lda, fundada em 4 de Maio de 1998, é uma empresa dinâmica, direccionada para o ramo de carpintaria.',
  ...
  en: {
    ...
    empresa: {
      ...
      about_p1: 'Capiarcos – Sociedade Unipessoal de Carpintaria, Lda, founded on 4 May 1998, is a dynamic carpentry company.',
  ...
  fr: {
    ...
    empresa: {
      ...
      about_p1: 'Capiarcos – Sociedade Unipessoal de Carpintaria, Lda, fondée le 4 mai 1998, est une entreprise dynamique de menuiserie.',
